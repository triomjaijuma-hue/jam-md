...
export default {
    ...
    async handler(sock, message, args, context) {
        ...
        try {
            ...
            const imgUrl = 'https://loremflickr.com/800/600/technology,innovation,digital/all?lock=' + seed;
            const { data } = await axios.get(imgUrl, { responseType: 'arraybuffer', timeout: 20000, maxRedirects: 5 });
            await sock.sendMessage(chatId, { image: Buffer.from(data), caption: '💡 Tech Image' }, { quoted: message });
        } catch (err) {
