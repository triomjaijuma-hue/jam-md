...
vi.mock('../../config.js', () => ({ default: { ownerNumber: '256765309986@s.whatsapp.net', prefixes: ['.'], botName: 'MEGA Bot', botMode: 'public' } }));
...
describe('handleMessages', () => {
    ...
    it('sends error response when command handler throws', async () => {
        ...
        const msg = createMockMessage({ text: '.crashtest', isGroup: true, senderId: '256765309986@s.whatsapp.net' });
        await handleMessages(sock, { messages: [msg], type: 'notify' });
