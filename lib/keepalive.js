 ...
 *  5. CPU guard  : monitors CPU usage every 30 s; throttles if above CPU_LIMIT (12%)
 *
...
// ── CPU state ──────────────────────────────────────────────────────────────
let _cpuThrottled = false;
let _overCount    = 0;
let _underCount   = 0;

/** Returns true when CPU is over the limit and heavy tasks should be deferred */
