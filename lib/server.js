...
export function startKeepAlive() {
    ...
    // Use hardcoded Wispbyte URL from config immediately — do NOT wait for an external
    // request to auto-detect the URL. On Wispbyte, nobody visits the bot's web page,
    // so auto-detection never fires and Wispbyte kills the container after ~10-15 min.
